...
public final class ResearchAgent: Sendable {
    ...
    public struct Result: Sendable {
        ...
        public init(objective: String, answer: String, visitedURLs: [String], duration: Duration) {
    ...
    public func research(_ query: String) async throws -> Result {
        ...
        if toolCallCount == 0 {
            if configuration.verbose {
                print("⚠️ WARNING: Model did not call any tools. Response may be based on outdated knowledge.")
            }
        }
    ...
    private static func researchInstructions(maxURLs: Int, blockedDomains: [String] = []) -> String {
        ...
        4. **Plan search keywords**: What terms will find relevant information?
           - Use the query language for searches (Japanese query → Japanese keywords)
